...
export class ShopPage {
    ...
    constructor(public navCtrl: NavController,
        ...
        this.manufacturer = navParams.get('data');
    ...
    getProducts(infiniteScroll) {
        ...
        dat.manu_id = this.manufacturer.id;


        this.httpClient.post(this.config.url + 'getallproducts', dat).subscribe((data: any) => {
            console.log(data);
            console.log("Manufacturer: ", this.manufacturer.id);
            ...
            if (data.success == 1) {
                ...
                // console.log(prod);
                // console.log('Prod ID:' , data.product_data.manufacturers_id);
                // console.log('Man ID: ', this.manufacturer.id);

                    for (let value of prod) {
                        if(value.manufacturers_id == this.manufacturer.id) {
            ...
            if (data.message != "Empty record.") {
                this.getProducts(infiniteScroll);
            }
            //
            // console.log("Outttt.")

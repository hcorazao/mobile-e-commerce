...
export class ConfigProvider {
  ...
  public yourSiteUrl: string = 'http://emallq.com';
  public consumerKey: string = "e848f82d1558730077dd251629";
  public consumerSecret: string = "fa245b941558730077f309daaf";
  ...
  public siteSetting() {
    ...
    return new Promise(resolve => {
      this.http.get(this.url + 'sitesetting', options).map(res => res.json()).subscribe((data: any) => {
        ...
        // this.manufacturerPage = settings.manu
